...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos del Abonados &raquo; Agregar datos</h2>
			<hr />
			...
			if(isset($_POST['add'])){
				...
				/*/ GUARDAR EN CLIENTES **/
				$cek = mysqli_query($con, "SELECT * FROM clientes WHERE codigo='$codigo'");
				$fotoContador			 = addslashes(file_get_contents($_FILES["fotoContador"]["tmp_name"]));
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO clientes (codigo, nombres, lugar_nacimiento, fecha_nacimiento, direccion, telefono, puesto, estado, fotoContador)
															VALUES('$codigo','$nombres', '$lugar_nacimiento', '$fecha_nacimiento', '$direccion', '$telefono', '$puesto', '$estado', '$fotoContador')") or die(mysqli_error());
						if($insert){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO lectura (codigo, nombres, lugar_nacimiento, fecha_nacimiento, direccion, telefono, puesto, estado)
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="nombres" class="form-control" placeholder="Nombre y Apellido" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Barrio o Colonia</label>
					<div class="col-sm-4">
						<input type="text" name="lugar_nacimiento" class="form-control" placeholder="Barrio o Colonia" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Fecha de Activación</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Número Contador</label>
					<div class="col-sm-3">
						<input type="text" name="puesto" class="form-control" placeholder="Nº Contador" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3" >
						...
						<input type="file" name="fotoContador" accept="image/*" required >
