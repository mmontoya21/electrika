...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos de Abonados &raquo; Editar datos</h2>
			<hr />
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($con, "UPDATE clientes SET nombres='$nombres', lugar_nacimiento='$lugar_nacimiento', fecha_nacimiento='$fecha_nacimiento', direccion='$direccion', telefono='$telefono', puesto='$puesto', estado='$estado' WHERE codigo='$nik'") or die(mysqli_error());
				if($update){
