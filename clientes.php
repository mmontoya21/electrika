	...
	<div class="container">
		<div class="content">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM clientes WHERE codigo='$nik'");
			...
			<table class="table table-striped table-hover">
				...
				<?php
				if($filter){
					$sql = mysqli_query($con, "SELECT * FROM clientes WHERE estado='$filter' ORDER BY codigo ASC");
				}else{
				...
				if(mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td> 
							<img height="80" width="80" src="data:image/jpeg;base64,'.base64_encode ($row["fotoContador"]).'" alt="Contador"/>;
							</td>
